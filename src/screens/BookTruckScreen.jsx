...
function BookTruckScreen() {
  ...
  const vehicleTypes = [
    { id: 'truck', name: 'Truck', capacity: 'Up to 10 tons' },
    { id: 'van', name: 'Van', capacity: 'Up to 2 tons' },
    { id: 'pickup', name: 'Pickup', capacity: 'Up to 1 ton' },
    { id: 'trailer', name: 'Trailer', capacity: 'Up to 20 tons' },
    { id: 'container', name: 'Container', capacity: 'Up to 30 tons' }
  ];
